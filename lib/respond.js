...
const respond =(request, response) =>{
    ...
    //get the corresponding full ststic path located in the static folder
    const fullStaticPath = path.join(staticBasePath, pathname);
    
    //can we find something in fullStsticPath?
...
//        console.log(`${fullStaticPath} does not exist`);
    ...
    fileDetails.size = stat.size;
                ...
                //get the file mime type and add to the response header
    ...
    .then(mime => {
        ...
        //get the file size and add it to the rerponse header
